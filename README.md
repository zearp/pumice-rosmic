...
sudo podman run --privileged --rm -it --network=host -v /dev:/dev -v $PWD:/code:z -v /var/cache/kiwi:/var/cache/kiwi:z -w /code quay.io/rockylinux/rockylinux:10 /bin/bash
```
